...
int option,nombre_de_comptes_a_ajouter;
...
void affichage_tableau(int debut,int fin){
    ...
    for (int i = debut ; i < fin; i++) {
        printf("%d\n", comptes_bancaires_montants[i]);

        printf("%s\n", comptes_bancaires_cin[i]);

        printf("%s\n", comptes_bancaires_noms[i]);
    }
            ...
            case 4:{
                ...
                switch (option) {
                    ...
                    case 3 : {
                        ...
                        if(trouve == 0){
                            printf("Le montant saisie n existe pas, veuillez reinserer le montant : ");
                        }
                        else{
